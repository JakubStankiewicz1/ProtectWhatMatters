    ...
    <div className="aboutUsContainer">
      ...
      <div className="aboutUsContainerPartOne">
        ...
        <div className="aboutUsContainerPartOneTopPart">
          <p className="aboutUsContainerPartOneTopPartHeading">
            BEST POSSIBLE QUALITY AT A PRICE WHERE EVERYONE CAN PARTICIPATE
          </p>
        </div>
        ...
        <div className="aboutUsContainerPartOneBottomPart">
          ...
          <div className="aboutUsContainerPartOneBottomPartDivContainer">
            <div className="aboutUsContainerPartOneBottomPartDivContainerHeading">
              <p className="aboutUsContainerPartOneBottomPartDivContainerHeadingText">
                QUALITY & INNOVATION
              </p>
            </div>
        ...
        <div className="aboutUsContainerPartOneThird">
          ...
          <div className="aboutUsContainerPartOneThirdLeftPart">
            <div className="aboutUsContainerPartOneThirdLeftPartHeading">
              <div className="aboutUsContainerPartOneThirdLeftPartHeadingTextOne">
                QUALITY &
              </div>
              <div className="aboutUsContainerPartOneThirdLeftPartHeadingTextTwo">
                INNOVATION
              </div>
            </div>
            ...
            <div className="aboutUsContainerPartOneThirdLeftPartNormalContainer">
              ...
              <div className="aboutUsContainerPartOneThirdLeftPartNormalContainerText">
                OUR VISION
              </div>
            </div>
          </div>
          ...
          <div className="aboutUsContainerPartOneThirdRightPart">
            ...
            <div className="aboutUsContainerPartOneThirdRightPartFirst">
              <p className="aboutUsContainerPartOneThirdRightPartFirstText">
                We prioritize quality and innovation by utilizing cutting-edge
                materials and rigorous testing to ensure our products meet the
            ...
            <div className="aboutUsContainerPartOneThirdRightPartSecondPart">
              <p className="aboutUsContainerPartOneThirdRightPartSecondPartText">
                Our ballistic and stab-resistant gear is crafted with advanced
                technology, including lightweight yet durable materials like
                UHMWPE and Aramid fibers, providing superior protection without
            ...
            <div className="aboutUsContainerPartOneThirdRightPartThirdPart">
              <p className="aboutUsContainerPartOneThirdRightPartThirdPartText">
                We continuously innovate by integrating customer feedback and
                the latest industry advancements into our designs, resulting in
                protective equipment that is reliable, effective, and tailored
            ...
            <div className="aboutUsContainerPartOneThirdRightPartFourthPart">
              <button className="aboutUsContainerPartOneThirdRightPartFourthPartBtn">
                READ MORE
              </button>
            </div>
          </div>
      ...
      <div className="aboutUsContainerPartTwo">
        <img
          src={assets.aboutUs2}
          alt=""
          className="aboutUsContainerPartTwoImg"
        />
      </div>
        ...
        <div className="aboutUsContainerPartThreeTopPart">
          ...
          <div className="aboutUsContainerPartThreeTopPartLeft">
            <div className="aboutUsContainerPartThreeTopPartLeftHeading">
              <p className="aboutUsContainerPartThreeTopPartLeftHeadingTextOne">
                DANISH QUALITY
              </p>
              <p className="aboutUsContainerPartThreeTopPartLeftHeadingTextTwo">
                SINCE 2013
              </p>
            </div>
            ...
            <div className="aboutUsContainerPartThreeTopPartLeftTextCont">
              ...
              <p className="aboutUsContainerPartThreeTopPartLeftTextContText">
                PRODUCT QUALITY
              </p>
            </div>
          </div>
          ...
          <div className="aboutUsContainerPartThreeTopPartRight">
            <p className="aboutUsContainerPartThreeTopPartRightTextOne">
              Danish quality is synonymous with precision, reliability, and
              attention to detail, and here at Protection Group Denmark we
              embody these values in every product we create. We focus on using
              premium materials and cutting-edge technology which results in
              products that exceed international safety standards. This
              dedication to excellence reflects Denmark’s tradition of producing
              high-quality, durable, and innovative solutions in various
              industries.
            </p>
        ...
        <div className="aboutUsContainerPartThreeMiddlePart">
          <div className="aboutUsContainerPartThreeMiddlePartCont">
            <img
              src={assets.aboutUs3}
              alt=""
              className="aboutUsContainerPartThreeMiddlePartContImgOne"
            />
            <img
              src={assets.aboutUs4}
              alt=""
              className="aboutUsContainerPartThreeMiddlePartContImgTwo"
            />
          </div>
        </div>
        ...
        <div className="aboutUsContainerPartThreeBottomPart">
          <div className="aboutUsContainerPartThreeBottomPartTextContainer">
            <p className="aboutUsContainerPartThreeBottomPartTextContainerHeading">
              PGD'S HEADQUARTER IS BASED IN DENMARK. IT IS THE HEART OF OUR
              OPERATIONS,{" "}
              <p className="aboutUsContainerPartThreeBottomPartTextContainerHeadingColor">
                COMBINING RESEARCH, DEVELOPMENT, AND MANUFACTURING
              </p>
              . OUR DEDICATED TEAM WORKS TO ENSURE THAT SAFETY, PRECISION, AND
              COMMITMENT TO QUALITY COME TOGETHER SEAMLESSLY.
            </p>
          </div>

          <div className="aboutUsContainerPartThreeBottomPartInf">
            <div className="aboutUsContainerPartThreeBottomPartInfDiv" />
            <p className="aboutUsContainerPartThreeBottomPartInfText">
              BASED IN DENMARK
            </p>
          </div>
        </div>
      ...
      <div className="aboutUsContainerPartFour">
        <div className="aboutUsProductsContainer">
          ...
          <div className="aboutUsProductsContainerHeader">
            <h2 className="aboutUsProductsContainerHeaderTitle">
              Featured Products
            </h2>
            <p className="aboutUsProductsContainerHeaderSortProductCount">
        ...
        <div className="aboutUsContainerPartFiveContainer">
          ...
          <div className="aboutUsContainerPartFiveContainerTextContainer">
            <div className="aboutUsContainerPartFiveContainerTextContainerHeading">
              <p className="aboutUsContainerPartFiveContainerTextContainerHeadingOne">
                READ ABOUT
              </p>
              <p className="aboutUsContainerPartFiveContainerTextContainerHeadingOne">
                ALL OF OUR
            ...
            <div className="aboutUsContainerPartFiveContainerTextContainerButton">
              <button className="aboutUsContainerPartFiveContainerTextContainerButtonBtn">
                SHOP NOW
              </button>
            </div>
          </div>
