        ...
        <div className="accountContainerTopPart">
          ...
          <div className="accountContainerTopPartLeft">
            <img
              src={assets.account}
              alt=""
              className="accountContainerTopPartLeftImage"
            />
          </div>
          ...
          <div className="accountContainerTopPartRight">
            ...
            <div className="accountContainerTopPartRightOne">
              ...
              <div className="accountContainerTopPartRightOneInpOne">
                <p className="accountContainerTopPartRightOneInpOneText">
                  Username or email address *
                </p>
                <input type="text" />
              </div>
              <div className="accountContainerTopPartRightOneInpTwo">
                <p className="accountContainerTopPartRightOneInpTwoText">
                  Password *
                </p>
                <input type="password" />
              </div>
              <div className="accountContainerTopPartRightOneCheckbox">
                <input type="checkbox" />
                <p className="accountContainerTopPartRightOneCheckboxText">
                  Remember me
                </p>
              </div>
              <div className="accountContainerTopPartRightOneButton">
                <button className="accountContainerTopPartRightOneButtonBtn">
                  LOG IN
                </button>
              </div>
            ...
            <div className="accountContainerTopPartRightSecond">
              <div className="accountContainerTopPartRightSecondHeading">
                <p className="accountContainerTopPartRightSecondHeadingText">
                  REGISTER
                </p>
              </div>

              <div className="accountContainerTopPartRightSecondEmailDiv">
                <p className="accountContainerTopPartRightSecondEmailDivText">
                  Email address *
                </p>
                <input type="email" />
              </div>
              ...
              <div className="accountContainerTopPartRightSecondTextContainer">
                <p className="accountContainerTopPartRightSecondTextContainerTextOne">
                  A link to set a new password will be sent to your email
                  address.
                </p>
                <p className="accountContainerTopPartRightSecondTextContainerTextTwo">
              ...
              <div className="accountContainerTopPartRightSecondButtonContainer">
                <button className="accountContainerTopPartRightSecondButtonContainerBtn">
                  REGISTER
                </button>
              </div>
            </div>
