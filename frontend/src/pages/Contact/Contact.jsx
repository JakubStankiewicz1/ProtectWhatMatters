      ...
      <div className="contactMiddleContainer">
        <div className="contactMiddleContainerFirst">
          ...
          <div className="contactMiddleContainerFirstRight">
            <p className="contactMiddleContainerFirstRightOne">
              PROTECTION GROUP DENMARK SHOLESALE APS
            </p>
            <p className="contactMiddleContainerFirstRightTwo">
              Messingvej 13
              <br />
              DK-8940 Randers SV
              <br />
            ...
            <p className="contactMiddleContainerFirstRightThree">
              Telephone: +45 61274857
            </p>
            <p className="contactMiddleContainerFirstRightFour">
              VAT number: 39606321
            </p>
            <p className="contactMiddleContainerFirstRightFive">
              Please note that our headoffice is located in Denmark in the
              timezone UTC+1. We strive to reply within 24 hours from
              Monday-Friday.
            </p>
          </div>
        </div>
        ...
        <div className="contactMiddleContainerSecond">
          <p className="contactMiddleContainerFirstLeft">
            B2B / DIRECT INQUIRIES
          </p>
          <p className="contactMiddleContainerSecondText">
            For direct inquiries or B2B orders please contact
        ...
        <div className="contactMiddleContainerThird">
          ...
          <p className="contactMiddleContainerThirdText">
            For any questions regarding the webshop or your order please contact
        ...
        <div className="contactMiddleContainerFourth">
          <div className="contactMiddleContainerFourthLeftPart">
            <p className="contactMiddleContainerFourthLeftPartHeading">
              OTHER INQUIRIES
            </p>
          </div>
          ...
          <div className="contactMiddleContainerFourthRightPart">
            <div className="contactMiddleContainerFourthRightPartContainer">
              <div className="contactMiddleContainerFourthRightPartContainerName">
                <p className="contactMiddleContainerFourthRightPartContainerNameText">
                  YOUR NAME
                </p>
